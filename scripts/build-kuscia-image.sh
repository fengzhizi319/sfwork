...
#   bash scripts/build-kuscia-image.sh --help       # 显示帮助
#
# 构建完成后，可通过环境变量让 dev-start.sh 使用本地镜像:
...
TAG="${KUSCIA_VERSION}-${DATETIME}"
IMAGE_NAME="secretflow/kuscia:${TAG}"
...
BUILT_IMAGE="secretflow/kuscia:latest"
